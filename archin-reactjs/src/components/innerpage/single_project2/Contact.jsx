        ...
        <div className="row justify-content-between">
          <div className="col-lg-4">
            <div className="info wow fadeInUp slow" data-wow-delay="0.2s">
              <h3 className="fsz-45 fw-500">Faisons de votre rêve une réalité</h3>
              <h6 className="fsz-21 fw-400 mt-50"> 05 00 00 00 00 </h6>
              <p className="fsz-14 color-666 mt-15">
                AV af Farabi Tassila Agadir <br /> Contact@strapexmaroc.com
              </p>
            </div>
          </div>
